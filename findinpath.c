 ...
 * Return:
 *  - 0 on success.
 *  - 126 if the file is found but is a directory or lacks execution permissions.
...
/**
 * tokenize_path - Tokenize the PATH variable into an array of directories.
 * @data: A pointer to the program's data.
 *
 ...
 * Return:
 *  - 0 on success.
 *  - 126 if the file exists but is a directory or lacks execution permissions.
